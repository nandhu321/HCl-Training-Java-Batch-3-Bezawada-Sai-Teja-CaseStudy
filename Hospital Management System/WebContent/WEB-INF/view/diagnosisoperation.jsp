...
<div class="login-page">
  <div class="form">
<form action="${pageContext.request.contextPath}/processdiagnosis">
<button id="button1">Diagnosis Registration</button>
</form>
<form action="${pageContext.request.contextPath}/listDiagnosis">
<button>Registered Diagnosis</button>
</form>
