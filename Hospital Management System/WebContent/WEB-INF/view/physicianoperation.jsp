...
<button id="button1">Physician Registration</button>
</form>
<form action="${pageContext.request.contextPath}/listphysicians">
<button>Registered Physicians</button>
</form>
<form action="${pageContext.request.contextPath}/searchphysician">
<button>Search Physician</button>
</form>
</div>
</div>
</body>
