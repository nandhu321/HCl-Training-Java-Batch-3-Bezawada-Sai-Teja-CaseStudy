  ...
  <div class="col-md-offset-1 col-md-10">
   ...
   <div class="panel panel-info">
    <div class="panel-heading">
     <div align="center"  style="color:blue;" class="panel-title"><h3>Patient List</h3></div>
    </div>
    ...
    <c:if test="${pa!=null}">
     <table align="center" border="1"   class="table table-striped table-bordered">
      ...
      <th>Action</th>
        ...
        <c:url var="deleteLink" value="/deletepa">
        <c:param name="paId" value="${pa.pid}" />
       </c:url>
       ...
       <tr>
        ...
        <td>${pa.email}</td>
		<td>${pa.dob}</td>
		<td>${pa.contactNumber}</td>
		<td>${pa.state}</td>
		<td>${pa.insurancePlan}</td>
