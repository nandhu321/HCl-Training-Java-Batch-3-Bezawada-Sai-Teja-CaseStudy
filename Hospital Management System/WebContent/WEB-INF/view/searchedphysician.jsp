  ...
  <div class="col-md-offset-1 col-md-10">
   ...
   <div class="panel panel-info">
    <div class="panel-heading">
     <div align="center"  style="color:blue;" class="panel-title"><h3>Physician List</h3></div>
    </div>
    ...
    <c:if test="${physician!=null}">
	 ...
	 <c:forEach  var="physician" items="${physician}">
      
        <c:url var="deleteLink" value="/deletephysician">
        <c:param name="physicianId" value="${physician.eid}" />
       </c:url>
