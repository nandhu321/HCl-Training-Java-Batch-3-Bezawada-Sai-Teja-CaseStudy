  ...
  <div class="col-md-offset-1 col-md-10">
   ...
   <div class="panel panel-info">
    <div class="panel-heading">
     <div align="center"  style="color:blue;" class="panel-title"><h3>Diagnosis List</h3></div>
    </div>
    <div class="panel-body">
     <table align="center" border="1"   class="table table-striped table-bordered">
      ...
      <c:forEach var="tempDiagnosis" items="${diagnosis}">
		
        <c:url var="deleteLink" value="/deleteDiagnosis">
        <c:param name="diagnosisId" value="${tempDiagnosis.did}" />
       </c:url>

      
       <tr>
        <td>${tempDiagnosis.pid}</td>
        <td>${tempDiagnosis.symptoms}</td>
        <td>${tempDiagnosis.diagnosisProvided}</td>
		<td>${tempDiagnosis.eid}</td>
		<td>${tempDiagnosis.dod}</td>
		<td>${tempDiagnosis.followUpRequired}</td>
		<td>${tempDiagnosis.dof}</td>
       <td>${tempDiagnosis.billAmount}</td>
		<td>${tempDiagnosis.cardNumber}</td>
       <td>${tempDiagnosis.modeOfPayment}</td>
