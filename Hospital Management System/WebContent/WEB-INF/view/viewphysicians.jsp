  ...
  <div class="col-md-offset-1 col-md-10">
   ...
   <div class="panel panel-info">
    <div class="panel-heading">
     <div align="center"  style="color:blue;" class="panel-title"><h3>Physicians List</h3></div>
    </div>
    <div class="panel-body">
     ...
     <tr>
      ...
      <c:forEach var="tempPhysician" items="${physicians}">
        ...
        <c:url var="deleteLink" value="/deletephysician">
        <c:param name="physicianId" value="${tempPhysician.eid}" />
       </c:url>

      
       <tr>
        <td>${tempPhysician.physicianFName}</td>
        <td>${tempPhysician.physicianLName}</td>
        <td>${tempPhysician.department}</td>
		<td>${tempPhysician.qualification}</td>
		<td>${tempPhysician.yearsOfExperience}</td>
		<td>${tempPhysician.state}</td>
		<td>${tempPhysician.insurancePlan}</td>
